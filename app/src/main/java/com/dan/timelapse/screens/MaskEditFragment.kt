...
import com.dan.timelapse.TouchImageViewListener
import com.dan.timelapse.databinding.MaskEditFragmentBinding
...
class MaskEditFragment(activity: MainActivity, image: Mat, private val mask: Mat, private val onOKListener: (()->Unit)? = null ) : AppFragment(activity) {

    companion object {
        private const val RADIUS = 50f //dp

        fun show(activity: MainActivity, image: Mat, mask: Mat, onOKListener: (()->Unit)? = null ) {
